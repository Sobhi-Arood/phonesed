...
class _$PostCopyWithImpl<$Res> implements $PostCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      title: title == freezed ? _value.title : title as PostTitle,
      price: price == freezed ? _value.price : price as PostPrice,
      description: description == freezed
          ? _value.description
          : description as PostDescription,
      images:
          images == freezed ? _value.images : images as PostImagesList<String>,
      ...
      moreAccessories: moreAccessories == freezed
          ...
          : moreAccessories as PostMoreAccessories,
...
class _$_Post extends _Post {
  ...
  @override
  final PostImagesList<String> images;
  @override
