...
import 'package:phonesed/presentation/posts/post_watcher/filter_posts_watcher_page.dart';
import 'package:phonesed/presentation/profile/my_posts_watcher/my_posts_watcher_page.dart';
import 'package:phonesed/presentation/profile/profile_details_page/profile_details_page.dart';
...
@MaterialAutoRouter(
  ...
  routes: <AutoRoute>[
    ...
    MaterialRoute(page: ProfileDetailsPage),
    MaterialRoute(page: FilterPostsWatchPage),
